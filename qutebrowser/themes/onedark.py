...
c.colors.completion.odd.bg = bg_completion
...
# Màu nền của thanh trạng thái ở chế độ chuyển tiếp.
...
# Màu nền của thanh trạng thái ở chế độ lệnh.
c.colors.statusbar.command.bg = bg_command

# Màu nền trước của thanh trạng thái trong chế độ lệnh + duyệt riêng tư.
...
# Màu nền của thanh trạng thái ở chế độ dấu mũ.
